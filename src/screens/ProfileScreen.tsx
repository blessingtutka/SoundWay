        ...
        <View className="p-4">
          ...
          <View>
            ...
            <View className="flex gap-3">
              <Button
                onPress={() => navigation.navigate('Change' as never)}
                className="bg-blue-600 rounded-md flex flex-row items-center justify-center"
              >
              ...
              {!isEmailVerified && (
                <Button
                  ...
                  className="bg-blue-600 text-gray-200 rounded-md flex flex-row items-center justify-center"
                >
          ...
          <View>
            ...
            <Button
              ...
              className="bg-red-600 !text-white rounded-md flex flex-row items-center justify-center"
            >
