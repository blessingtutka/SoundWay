    ...
    <ScreenLayout>
      <Card className="w-fit bg-dark-trans self-center rounded-lg shadow-sm p-6 gap-4">
        ...
        <View className="flex-col items-center">
          ...
          <Text className="text-5xl font-extrabold text-[#0082f4]">
            SoundWay
          </Text>
          <Text className="text-base text-[#FFB4A6] mt-1 text-center">
            Find your local easly with SoundWay with a great level of assurance
          </Text>
          <Text className="text-[#1DAC5C] font-semibold mt-2 text-center">
            With SoundWay: Find your local.
          </Text>
        </View>
        ...
        <View className="flex-row items-center mt-3">
          <Text className="text-[#666] text-sm flex-shrink-1">
